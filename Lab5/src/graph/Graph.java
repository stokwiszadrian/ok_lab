...
public class Graph {
    ...
    public void applyFleury(int v, ArrayList<Edge> edgesLeft) {
        ArrayList<Edge> edgesFrom = edgesFromV(v);
        if (edgesFrom.size() == 1) {
    ...
    public ArrayList<Edge> edgesFromV(int v) {
    ...
    public int dfs(int v) {
        ...
        return visit(treelist, v);
    }

    public int visit(ArrayList<Integer> treelist, int v) {
